...
def transform_to_map_coordinates(tvec, rvec, tag_map_xy_cm=(100, 200)):
    """
    ...
    Transformation (generalized by tag anchor position):
    - x_new = tag_map_x + x_old (where x_old is tag X coordinate in cm)
    - y_new = tag_map_y - z_old (where z_old is tag Z coordinate in cm)
    ...
    # Apply transformation: x_new = tag_map_x + x_old, y_new = tag_map_y - z_old
